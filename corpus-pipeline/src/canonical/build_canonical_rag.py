...
from corpus.preprocess_rag_corpus import (
    SectionRecord,
    chunk_sections,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build canonical corpus and final RAG output."
    )
    parser.add_argument("--sections", type=Path, required=True)
    parser.add_argument("--chunks", type=Path, required=True)
    parser.add_argument("--tables", type=Path, default=DEFAULT_TABLES)
    parser.add_argument("--table-overrides", type=Path, default=DEFAULT_TABLE_OVERRIDES)
