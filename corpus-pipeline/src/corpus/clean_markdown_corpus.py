...
DEFAULT_SYLLABLES = RAW_DIR / "vietnamese_valid_syllables.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Create a conservative cleaned copy of the Markdown corpus."
    )
...
def main() -> None:
    ...
    output_path = process_corpus(input_path=args.input, output_path=args.output)
    print(output_path)
