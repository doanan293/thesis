...
from corpus_pipeline.corpus.sources.crawl import CrawlRequest, crawl_source
from corpus_pipeline.corpus.sources.tables import (
...
def crawl(
    ...
    def run() -> CommandResult:
        ...
        def fetch(url: str, timeout: float) -> bytes:
            with urlopen(
                Request(url, headers={"User-Agent": "corpus-pipeline"}), timeout=timeout
            ) as response:
