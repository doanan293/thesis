...
from corpus_pipeline.corpus.tables.curate_docling_tables import process_table_curation
from corpus_pipeline.corpus.tables.extract_docling_tables import process_tables
