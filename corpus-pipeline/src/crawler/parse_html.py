...
from config.paths import ANKHANG_MARKDOWN_INTERIM_DIR, RAW_ANKHANG_HTML_DIR
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Parse An Khang HTML into Markdown.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = parse_html_tree(args.input, args.output)
