...
from evaluation.build_section_retrieval_eval import (
    ankhang_candidates,
...
def main() -> None:
    rows = build_patient_queries()
    print(
        f"Successfully generated exactly {len(rows)} An Khang patient queries in {DEFAULT_OUTPUT_PATH}"
    )
