...
from corpus.preprocess_rag_corpus import OFFICIAL_GENERAL_MONOGRAPHS
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Validate final RAG data and write a unified quality report."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = validate_final_rag(include_deep_audit=True)
    ...
    print(f"auto_fixable: {report.auto_fixable_count}")
