...
from corpus_pipeline.cache.jsonl_records import append_record
from corpus_pipeline.evaluation import rerank_service
...
def test_kaggle_rerank_allows_different_models_in_the_same_run(
    ...
    from corpus_pipeline.evaluation import rerank_service
    from corpus_pipeline.integrations.kaggle import job_lock
