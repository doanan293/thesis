...
from pharma_lab.bundle.export import COLLECTION_KEY
from pharma_lab.cli.options import positive_int
...
from pharma_lab.config.paths import BACKEND_ENV_FILE, GOLD_DIR, run_dir
from pharma_lab.evaluation.backend_retrieval import RetrieveRequest, run_retrieval
...
def retrieve(
    ...
    query_embeddings: Annotated[
        ...
        typer.Option(
            "--query-embeddings",
            dir_okay=False,
            help="Query embedding cache from `pharma-lab embed queries` (dense and hybrid)",
        ),
    ] = None,
