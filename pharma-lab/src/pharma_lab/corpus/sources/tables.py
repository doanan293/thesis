...
from pharma_lab.corpus.tables.curate_docling_tables import process_table_curation
from pharma_lab.corpus.tables.extract_docling_tables import process_tables
