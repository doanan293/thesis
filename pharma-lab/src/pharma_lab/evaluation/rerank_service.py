...
from pharma_lab.artifacts.bundle import ArtifactBundle, load_bundle
from pharma_lab.cache.jsonl_records import ValidatedSubset, merge_records
...
from pharma_lab.evaluation.local_rerank_benchmark import (
    ComposeRerankServer,
...
from pharma_lab.evaluation.rerank_log import open_rerank_log
from pharma_lab.evaluation.rerank_score_cache import (
    RerankScoreCache,
)
from pharma_lab.evaluation.rerankers import LlamaCppReranker, Reranker
...
from pharma_lab.runtime.compose import LlamaCppComposeManager, reranker_environment
...
class KaggleRerankBackend:
    ...
    def _recover_kernel(request: RerankRequest) -> RerankStageResult:
        ...
        if context is None:
            raise ValueError(
                f"No Kaggle account profile in pharma-lab/.env has username {owner}"
            )
