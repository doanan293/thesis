...
from pharma_lab.runtime.benchmarking import KAGGLE_RERANK_BENCHMARK_GROUPS
...
class CorpusEmbedStage:
    ...
    def build_job(self, request: StageRequest) -> StageJob:
        ...
        return StageJob(
            ...
            worker_module="pharma_lab.integrations.kaggle.workers.corpus_embed",
            worker_config={
                "model": request.model,
...
class BenchmarkStage:
    ...
    def build_job(self, request: StageRequest) -> StageJob:
        ...
        return replace(
            ...
            worker_module="pharma_lab.integrations.kaggle.workers.benchmark",
