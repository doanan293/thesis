...
from pharma_lab.artifacts.contract import (
    build_manifest,
...
from pharma_lab.artifacts.publisher import publish_contract
...
from pharma_lab.corpus.canonical.build_canonical_rag import process_canonical_rag
from pharma_lab.corpus.crawling.integrate_leaflets import integrate_leaflet_corpus
from pharma_lab.corpus.crawling.parse_html import parse_html_tree
from pharma_lab.corpus.processing.clean_markdown_corpus import (
    process_corpus as clean_corpus,
)
from pharma_lab.corpus.processing.extract_pymupdf_text import process_pdf
from pharma_lab.corpus.processing.preprocess_rag_corpus import (
    process_corpus as preprocess_corpus,
)
from pharma_lab.corpus.sources.leaflet_source import verify_leaflet_source
from pharma_lab.corpus.validation.validate_final_rag import (
...
PIPELINE_VERSION = version("pharma-lab")
