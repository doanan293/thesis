...
def test_stateless_policy_rejects_negative_cache_limit():
    from pharma_lab.runtime.server_policy import InferenceCachePolicy
...
def test_managed_model_servers_reports_early_process_failure(monkeypatch, tmp_path):
    from pharma_lab.integrations.kaggle.workers import runtime
    from pharma_lab.runtime import client
