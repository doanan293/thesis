...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("data/evaluation/e2e/golden_e2e.jsonl", True),
        ("data/evaluation/e2e/golden_e2e.manifest.json", False),
        ("data/evaluation/e2e/authoring/answerable-01.todo.jsonl", True),
        ("data/evaluation/e2e/runs/probe/full/run.json", False),
        ("data/evaluation/e2e/runs/probe/full/answers.jsonl", True),
        ("data/evaluation/e2e/runs/probe/reports/main.csv", False),
