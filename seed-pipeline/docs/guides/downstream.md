...
10. Corpus lúc chạy nằm trong schema `corpus` của backend (Postgres là nguồn chính, Qdrant là index dẫn xuất), nạp bằng `pharma-agent corpus import ../seed-pipeline/data/corpus/formulary --collection formulary --publish`. seed-pipeline không ghi thẳng vào Postgres hay Qdrant.
